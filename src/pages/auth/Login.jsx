    ...
    <div className="screen auth-screen active">
      <div className="auth-container">
        <div className="auth-header">
          <div className="auth-logo">
            <span className="auth-logo-icon" aria-hidden="true">
              <img src={limitlessIcon} width="32" height="18" alt="" />
            </span>
            <span className="auth-logo-text">LIMITLESS</span>
          </div>
        ...
        <div className="auth-powered-by">
          Powered by{' '}
          <a href="https://brainbank.world" target="_blank" rel="noopener noreferrer">
            BrainBank and Human First AI
          </a>
        </div>
      </div>
    </div>
